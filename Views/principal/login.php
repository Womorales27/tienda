                            ...
                            <div class="login slide-up">
                                <div class="center">
                                    ...
                                    <div class="form-holder mb-3">
                                        <input type="email" id="email" class="input" placeholder="Email" value="admin2@gmail.com"/>
                                        <input type="password" id="password" class="input" placeholder="Password" value="123" />
                                    </div>
